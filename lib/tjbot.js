 ...
 */
TJBot.prototype.version = 'v1.2.1 Two Arms Multiple LEDs on chain';

/**
 * List of TJBot hardware and services.
 */
TJBot.prototype.capabilities = ['analyze_tone', 'converse', 'listen', 'see', 'shine', 'speak', 'translate', 'wave', 'leftArm', 'rightArm'];
TJBot.prototype.hardware = ['camera', 'led', 'microphone', 'servo', 'speaker', 'leftArm', 'rightArm'];
...
TJBot.prototype.defaultConfiguration = {
	...
	leftArm: { //adding left arm
        servoPin: 8 // corresponds to BCM 8 / physical PIN 24
    },

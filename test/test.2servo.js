...
var tj = new TJBot(['servo'], {log: {level: 'debug'},wave: { servoPin: 8 }}, {});  // left arm
var tj2 = new TJBot(['servo'], {log: {level: 'debug'},wave: { servoPin: 25 }}, {}); // right arm

tj.armBack();
tj2.armBack();
var answer = rl.question('Is TJBot\'s left arm in the BACKWARD position? Y/N > ');
...
tj.raiseArm();
tj2.raiseArm();
answer = rl.question('Is TJBot\'s left arm in the RAISED position? Y/N > ');
if (answer.toLowerCase() != 'y') {
...
tj.lowerArm();
tj2.lowerArm();
answer = rl.question('Is TJBot\'s left arm in the LOWERED position? Y/N > ');
if (answer.toLowerCase() != 'y') {
